...
class Settings(BaseSettings):
    ...
    #
    # ⚠️ القيمة الفعلية المستخدَمة أثناء التشغيل هي cv/config.py::SCAN_TIMEOUT
    # لأن العدّ التنازلي يجري داخل محرّك الرؤية نفسه (theft_logic.py) وليس
    # في alert_handler. أبقيناها هنا للتوافق مع أي كود قديم يقرأها.
    CART_BRAKE_GRACE_SECONDS: float = 8.0
